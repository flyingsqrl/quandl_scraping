...
Script Name: USDA_LM_PK602_SCRAPER_HIST
...
05/24/2014      Bill Cary   Modification of original script to process historical data
                            for one-time load to Quandl
...
file_name = './data/LM_PK602_full_lmr_ws.xml' # file obtained separately from USDA data mart
...
file.write('code: USDA_LM_PK602_CUTOUT_PRIMAL\n')
file.write('name: Daily USDA pork cutout and primal values\n')
file.write('description: "Daily pork cutout and primal values from the USDA LM_PK602\n')
file.write('  report published by the USDA Agricultural Marketing Service (AMS).\n')
file.write(reference_text + '"\n')
file.write('reference_url: http://www.ams.usda.gov/mnreports/lm_pk602.txt\n')
file.write('frequency: daily\n')
file.write('private: false\n')
file.write('---\n')
primal_df.to_csv(file)
file.write('\n')
file.write('\n')
#---------------------------------------------------------------------------------------------
...
file.write('code: USDA_LM_PK602_VOLUME\n')
file.write('name: Daily pork volume (full loads and trim/process loads)\n')
file.write('description: "Daily pork volume (full loads and trim/process loads) from the USDA LM_PK602\n' \
...
for cut in set(cuts_df['Description']): # Iterate through the list of unique Descriptions
    ...
    file.write('code: ' + quandl_code + '\n')
    file.write('name: Pork ' + name + '\n')
    file.write('description: "Daily total pounds, low price, high price and weighted average price ' \
